...
@section('breadcrumb', 'CREATE EDUCATION')
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" name="deegre" class="form-control" value="">
                        ...
                        <a href="{{ route('dashboard.education.index') }}" type="submit" class="btn btn-secondary">Back</a>
                    </div>
                </form>
            </div>
        </div>
